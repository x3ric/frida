✄
...
Il2Cpp.perform(() => {
    ...
    // CoinsDealer::InstantiateCoins(this = CoinDealer (-257.3, -22.4, 0.0), amount = 2, isTrash = false)
    //const CoinsDealer = Il2Cpp.domain.assembly("Assembly-CSharp").image.class("CoinsDealer");
    //const InstantiateCoins = CoinsDealer.method("InstantiateCoins");
    //InstantiateCoins.implementation = function(pos, amount, isTrash) {
    //    console.log(`Original call -> this: ${this}, pos: ${pos}, amount: ${amount}, isTrash: ${isTrash}`);
    //    amount = 99999;
    //    isTrash = false;
    //    console.log(`Custom   call -> this: ${this}, pos: ${pos}, amount: ${amount}, isTrash: ${isTrash}`);
    //    return this.method("InstantiateCoins").invoke(pos, amount, isTrash);
    //};
});
...
async function main(mainActivity) {
    ...
    // Hooking methods
    CharacterMotor.method('CheckFrontalImpact').implementation = function (impactState) {
        if (isNoColision.get())
            return false;
        return this.method('CheckFrontalImpact').invoke(impactState);
    };
    CharacterMotor.method('CheckSideImpact').implementation = function (impactState) {
        if (isNoColision.get())
            return false;
...
✄
{"version":3,"file":"util.js","sourceRoot":"/home/e/Private/.local/opt/Frida/hacks/frida-menu/","sources":["src/util.ts"],"names":[],"mappings":"AAAA,MAAM,UAAU,KAAK,CAAC,EAAU;IAC9B,OAAO,IAAI,OAAO,CAAC,CAAC,OAAO,EAAE,EAAE,CAAC,UAAU,CAAC,OAAO,EAAE,EAAE,CAAC,CAAC,CAAC;AAC3D,CAAC;AAED,MAAM,UAAU,WAAW,CAAC,YAAoB;IAC9C,IAAI,QAAsB,CAAC;IAE3B,IAAI,CAAC,MAAM,CAAC,YAAY,EAAE;QACxB,OAAO,EAAE,UAAU,QAAQ;YACzB,QAAQ,GAAG,QAAQ,CAAC;QACtB,CAAC;QACD,UAAU,EAAE,cAAa,CAAC;KAC3B,CAAC,CAAC;IAEH,OAAO,OAAO,CAAC,OAAO,CAAC,QAAS,CAAC,CAAC;AACpC,CAAC;AAED,MAAM,CAAC,KAAK,UAAU,uBAAuB,CAAC,GAAG,OAAiB;IAChE,OAAO,OAAO,CAAC,MAAM,GAAG,CAAC,EAAE;QACzB,MAAM,EAAE,GAAG,OAAO,CAAC,GAAG,EAAE,CAAC;QACzB,IAAI,CAAC,EAAE;YAAE,OAAO;QAEhB,IAAI,CAAC,MAAM,CAAC,cAAc,CAAC,EAAE,CAAC,EAAE;YAC9B,OAAO,CAAC,GAAG,CAAC,eAAe,EAAE,uBAAuB,CAAC,CAAC;YACtD,MAAM,KAAK,CAAC,GAAG,CAAC,CAAC;YACjB,OAAO,CAAC,IAAI,CAAC,EAAE,CAAC,CAAC;SAClB;KACF;AACH,CAAC;AAED,MAAM,UAAU,iBAAiB,CAAC,EAAc;IAC9C,IAAI,CAAC,OAAO,CAAC,GAAG,EAAE;QAChB,MAAM,CAAC,OAAO,CAAC,EAAE,CAAC,CAAC;IACrB,CAAC,CAAC,CAAC;AACL,CAAC"}
✄
...
export async function ensureModuleInitialized(...modules) {
...
export function JavaIl2cppPerform(fn) {
    Java.perform(() => {
        Il2Cpp.perform(fn);
    });
}